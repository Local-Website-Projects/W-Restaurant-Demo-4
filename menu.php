...
<head>
    ...
    <title>Menu - The Henley Southlake</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="breadcrumb-inner text-center">
                        ...
                        <h2 class="heading-title" data-sal="slide-up" data-sal-delay="120" data-sal-duration="800">Menu</h2>
                        <h1 class="main-title" data-sal="slide-up" data-sal-delay="120" data-sal-duration="800">Special Menus</h1>
                    </div>
    ...
    <div class="rts-menu-area menu rts-section-gap">
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat3">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="#">Wild Mushroom Arancini</a></p>
                                <span class="price">$33.00</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat1">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="#">Fresh Oysters Dozen</a></p>
                                <span class="price">$30.00</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat2 cat3">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="#">Bruno’s Scribble</a></p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 grid-item cat1">
                    <div class="portfolio-wrapper2 mb-30">
                        ...
                        <div class="portfolio-content">
                            ...
                            <div class="content">
                                <p class="title"><a href="#">Purple Corn Tostada</a></p>
            ...
            <div class="button-area-banner" data-sal="slide-up" data-sal-delay="300" data-sal-duration="800">
                <a href="menu.php" class="rts-btn btn-secondary">Get Free Tour</a>
            </div>
        </div>
    </div>
    <!-- MENU area end -->
...
<!-- Mirrored from themewant.com/products/html/dinenos/menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 11:07:53 GMT -->
</html>