    ...
    <div class="header-top">
        <div class="start-top">
            <div class="single-info">
                ...
                <p>1400 Plaza Place Southlake, Texas 76092</p>
            </div>
        </div>
        <div class="end-top">
            <div class="single-info">
                <div class="icon"><i class="fas fa-envelope-open"></i></div>
                <a href="mailto:info@TheHenleyDallasSouthlake.com">info@TheHenleyDallasSouthlake.com</a>
            </div>
        </div>
    </div>
        ...
        <div class="inner-main-wrapper-desk d-none d-lg-block">
            ...
            <div class="inner-content">
                <ul class="feature-list">
                    <li class="query-list">
                        <span class="sub-text">1400 Plaza Place Southlake, Texas 76092</span>
                        <a class="phone" href="tel:99988899900">+936 887-456-23</a>
                        <a class="email" href="mail-to_info@TheHenleyDallasSouthlake.com">info@TheHenleyDallasSouthlake.com</a>
                    </li>
